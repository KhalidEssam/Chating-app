...
export class Message {
  ...
  @ApiProperty({
    type: () => User,
    description: 'The recipient user of the message (for direct messages)',
    nullable: true,
    required: false,
  })
  ...
  @ApiProperty({
    type: () => Group,
    description: 'The group this message belongs to (for group messages)',
    nullable: true,
    required: false,
  })
  ...
  @ApiProperty({
    description:
      'Name of the sender (can be denormalized for performance or derived)',
    example: 'john_doe',
  })
  @Column()
  ...
  @ApiProperty({
    description: 'Identifier for the chat room or conversation',
    example: 'user1_user2_dm',
  })
  @Column()
  ...
  @ApiProperty({
    description: 'Timestamp of when the voice message was created',
    type: Date,
  ...
  @ApiProperty({
    description: 'Timestamp of when the voice message was last updated',
    type: Date,
    example: '2024-06-04T12:00:00.000Z',
  })
  @UpdateDateColumn()
